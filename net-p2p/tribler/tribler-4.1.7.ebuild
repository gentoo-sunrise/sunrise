...
src_install() {
	dodir /usr/share/${PN}
	newbin tribler.sh tribler || die "Error: newbin failed"
	insinto /usr/share/${PN}
	doins -r ABC BitTornado Tribler Utility Dialogs icons Lang test \
	...
	insopts -m0700
	doins btcreatetorrent.py btlaunchmany.py bttrack.py || die "Error: doins failed"
